...
const MenuLink = ({ bg }) => {
        ...
        if (area === 'newProject') {
            ...
            return (
                <NavLink style={{ pointerEvents: 'none'}}>
                    <div className="div-svg">
                        <svg className="color-red" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="512" height="512">
    ...
    return (
        <div className="menu-div">
            <nav className={ `menu ${hamburguerActived} ${bg}` }>
                ...
                <ul className={ `${hamburguerActived} menuNormal` }>
                    ...
                    <li className="notification-dropside" onClick={ e => notificationClicked(e) }>
                ...
                <ul className={ `notification-menu ${notificationAct ? 'actived' : ''}` }>
                    <div>
                        <h4>
                    ...
                    { notifications.map((notItem, index) => (
                        render(notItem[0], notItem[1], notItem[2], notItem[3])
                    )) }
                </ul>
            </nav>
        </div>
